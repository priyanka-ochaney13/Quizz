    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_address', models.CharField(max_length=60, null=True, unique=True)),
                ...
                ('gender', models.CharField(blank=True, choices=[('Female', 'Female'), ('Male', 'Male'), ('Other', 'Other')], max_length=15, null=True)),
